...
import {  handleAddAdmin, handleAddRound, handleDeleteRound, handleEditRound, handleGetAdmins, handleGetRounds, handleRevokeAdmin, handleSelectRound, ScoringInterface, SignedScoringInterface } from './handler';
...
export default {
    ...
    router.options("/round/:id", handleCors);
